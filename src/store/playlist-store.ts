...
//         console.log(`Setting tracks for artist: ${artistName}`, tracks);
//         set(state => {
//           if (!state.currentSession || !state.currentSession.artists[artistName]) return state;
//           console.log(`Current tracks for ${artistName}:`, state.currentSession.artists[artistName].tracks);
//           const updatedSession = {
//             ...state.currentSession,
//             artists: {
//               ...state.currentSession.artists,
...
//         console.log(`Adding tracks for artist: ${artistName}`, newTracks);

//         set(state => {
//           console.log(`Current session state:`, state.currentSession);
//           console.log(`Current session artists:`, state.currentSession?.artists);
//           if (!state.currentSession || !state.currentSession.artists[artistName]) return state;
          
//           const existingTracks = state.currentSession.artists[artistName].tracks;
//           console.log(`Existing tracks for ${artistName}:`, existingTracks);
//           const existingIds = new Set(existingTracks.map(t => t.id));
//           console.log(`Existing track IDs for ${artistName}:`, existingIds);
//           const uniqueNewTracks = newTracks.filter(t => !existingIds.has(t.id!));
//           console.log(`Unique new tracks for ${artistName}:`, uniqueNewTracks);
